...
In this section, supervised contrastive learning is applied on a CV classification task, and compared to a baseline image multi-class classification model that does not.
